...
public class GameManager : MonoBehaviour
{
    ...
    public double AutoCollectPercentage = 0.1;
...

    {
...

        {
            if(_totalGold >= 1000)
            {
                AchievementController.Instance.UnlockAchievement(AchievementType.KayaRaya, "Sultan");
                udahJadiSultan = true;
            }
        }
...

    {
        ...
        AutoCollectInfo.text = $"Ngepet: { output:F1} / detik";
...

    {
        ...
        GoldInfo.text = $"Cuan: { _totalGold.ToString("0") }";
...

    {
        ...
        CoinIcon.transform.localScale = Vector3.one * .75f;
